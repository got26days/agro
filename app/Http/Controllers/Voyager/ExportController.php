...
class ExportController extends \TCG\Voyager\Http\Controllers\VoyagerBaseController
{
    ...
    public function store(Request $request)
    {
        ...
        if (!$request->has('_validate')) {
            ...
            // return $data;
            $superfile = json_decode($data['file'],true)[0]['download_link'];
            
            // return $superfile;
            $path = './public/' . $superfile;

            $newex = Excel::import(new DownloadImport, $path);
