...
$(document).ready(function(){
    ...
    function enterClose(){
        $('#js-enter-popup').fadeOut(250);
        $(window).unbind('scroll');
    }
    $('.js-enter').on('click', function(){
        enterOpen();
    });
    $('.js-enter-popup-close').on('click', function(){
        enterClose();
    });
	
	/*restore*/ 
    function restoreOpen(){
        $('#js-restore-popup').fadeIn(250);
        var topPos = $(window).scrollTop();
        $(window).scroll(function(){
            $(this).scrollTop(topPos);
        });
    ...
    $('.js-restore-popup-close').on('click', function(){
        restoreClose();
    });
