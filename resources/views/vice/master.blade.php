...
<body>
    ...
    <div class="popup" id="js-popup">
        ...
        <a class="btn action-btn js-action-btn" href="#sec-form" id="js-action-btn" data-title="Оформить заявку" data-titletwo="Оформить заявку" data-btn="Оформить заявку"><span>Оформить заявку</span></a>
