                ...
                <div class="container">
                    <div class="calc-banner__wrap">
                        <div class="calc-banner__col">
                            <b>{{ isset($domain['price_two']) ? $domain['price_two'] : '95% одобрений'}}</b>наша статистика по отрасли
                        </div>
                        <div class="calc-banner__col">
                            <b>
